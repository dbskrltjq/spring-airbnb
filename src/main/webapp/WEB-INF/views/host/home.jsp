	...
	<div id="starting-host" class="position-relative">
		...
		<div class="text-center bg-black" id="left-div">
			<div class="align-self-center d-inline">
				...
				${LOGIN_USER.name }님 환영합니다.<br>
					<br>
					<button type="button" class="btn text-white" style="background-color: #FF385C;" onclick="location.href='/host/become-a-host';">호스팅을 시작하기</button>
				</c:if>
				...
				<button type="button" id="btn-open-form-modal" class="btn text-white"
				 ...
				 -->
					<button type="button" id="btn-open-form-modal" class="btn text-white" style="background-color: #FF385C;" data-bs-toggle="modal" data-bs-target="#email-login-modal">로그인하고 호스팅을 시작하기</button>
				</c:if>
			</div>
		</div>
		...
		<div id="right-div">
			<div class="align-self-center">
				<!-- 동영상 -->
				<video class="host-video" autoplay controls muted crossorigin="anonymous" playsinline="" preload="auto" style="object-fit: cover; object-position: center top;">
